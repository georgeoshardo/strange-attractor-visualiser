...
def test_desktop_main_window_defaults_to_lines_with_density():
    ...
    from strange_attractor_visualiser.desktop.widgets import LINE_INTERPOLATION, MainWindow
    ...
    assert window.current_settings().line_interpolation == LINE_INTERPOLATION
    window.window.close()
    app.processEvents()
